...
The core technology behind these AI successes is reinforcement learning. Reinforcement learning is a machine learning paradigm (alongside supervised and unsupervised learning) that learns an optimal sequence of actions to take in the environment. In contrast, supervised learning learns a single output prediction based on an existing training dataset of labels, and unsupervised learning learns the distribution of data without any given labels.

<figure align="center">
    <img src="https://upload.wikimedia.org/wikipedia/commons/a/aa/Ivan_Pavlov_research_on_dog%27s_reflex_setup.jpg" alt='missing' />
    <figcaption align="center">Pavlov's Dog</figcaption>
</figure>

As you may have expected, reinforcement learning is closely related to (and is in fact inspired by) the same concept behind [Pavlov's Dog](https://en.wikipedia.org/wiki/Classical_conditioning), operant conditioning. [Operant conditioning](https://en.wikipedia.org/wiki/Operant_conditioning) is a learning process that associates and modifies behaviours with reinforcement or punishment. This is well described by Edward Thorndike's [Law of Effect](https://en.wikipedia.org/wiki/Law_of_effect), which states that "responses that produce a satisfying effect in a particular situation become more likely to occur again in that situation, and responses that produce a discomforting effect become less likely to occur again in that situation."

<figure align="center">
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Reinforcement_learning_diagram.svg/250px-Reinforcement_learning_diagram.svg.png" alt='missing' />
    <figcaption align="center">Reinforcement Learning Paradigm</figcaption>
</figure>

The process of reinforcement learning takes place in 4 stages: 1) The environment's state is first observed by the agent. 2) The agent takes an action based on the observation. 3) The agent's action influences the environment's state. 4) The environment then returns a new state to the agent, along with a reward indicating the goodness of the action taken.

<figure align="center">
    <img src="https://miro.medium.com/max/1400/0*POUA1aMqAab5GiYM.png" alt='missing' />
    <figcaption align="center">Grab's Demand & Supply Prediction Algorithm</figcaption>
</figure>

Reinforcement learning is currently used by a few applications in industry, namely recommending personalised advertisements, improving search engines, and more recently, improving pricing algorithms of ride-hailing applications based on live demand and supply. While RL currently does not have as many applications as domains like computer vision and natural language processing, RL is a promising and upcoming method with high potential in fields like robotics (think automating thousands of manual processes in factories), self-driving vehicles (think reducing accident rates while significantly improving logistics transportation efficiency) and, of course, video games (who doesn't enjoy seeing games being solved/mastered?)
...
<figure align="center">
    <img src="https://miro.medium.com/max/2508/1*TU0hbeyL3e90dJ6PL1r5SA.png" alt='missing' />
    <figcaption align="center">Machine Learning Crash Course by Google</figcaption>
</figure>
...
This tutorial presents the theory of RL at an introductory level. It formalises the RL paradigm with math, and is a great resource so that concepts are rigorous and not too hand-wavy. The math and notation make look intimidating, but if you understand the underlying motivation and concepts, understanding the notation will come naturally. Follow through thoroughly and you will be rewarded well. Topics covered: Dynamic programming, Value iteration, Q-learning, Temporal difference learning, Discounting rewards. Nonetheless, if you're unable to follow through, you should face no problem proceeding with the next resource on Medium.

## 3. [Deep RL Course on Medium](https://simoninithomas.github.io/deep-rl-course/) by Thomas Simonini

<figure align="center">
    <img src="https://miro.medium.com/max/2560/1*1zWc14QuMnyRhg5K4I4qIg.jpeg" alt='missing' />
    <figcaption align="center">Deep RL Course on Medium by Thomas Simonini</figcaption>
</figure>
...
<figure align="center">
    <img src="https://raw.githubusercontent.com/clvrai/awesome-rl-envs/master/media/furn.gif" alt='missing' />
    <figcaption align="center">IKEA Furniture Assembly Simulation Environment</figcaption>
</figure>
...
<figure align="center">
    <img src="https://stable-baselines3.readthedocs.io/en/master/_static/logo.png" alt='missing' />
    <figcaption align="center">Stable Baselines 3</figcaption>
</figure>
...
<figure align="center">
    <img src="https://spinningup.openai.com/en/latest/_static/spinning-up-logo2.png" alt='missing' />
    <figcaption align="center">Spinning Up by OpenAI</figcaption>
</figure>
...
<figure align="center">
    <img src="https://lh3.googleusercontent.com/proxy/JH4iX71AGnz_nbr8-10BXOMATau8_PgLCusKmYQOaS23_0hQfs0X0yUpfEbYAqaw0ii_W4SVGRfYtmCIbmeuB0FfwCcQ" alt='missing' />
    <figcaption align="center">Reinforcement Learning: An Introduction, by Sutton and Barto</figcaption>
</figure>
...
<figure align="center">
    <img src="https://i2.wp.com/blog.rstudio.com/2020/12/07/distill/distill-pub.png?w=720&ssl=1" alt='missing' />
    <figcaption align="center">Distill Interactive Articles</figcaption>
</figure>
...
<figure align="center">
    <img src="https://i.ytimg.com/vi/o75ybZ-6Uu8/maxresdefault.jpg" alt='missing' />
    <figcaption align="center">Yannic Kilcher's Video on the DreamerV2 Paper</figcaption>
</figure>
